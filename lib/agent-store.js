...
class AgentStore {
  ...
  _seedDemoAgents() {
    ...
    this.s.insertAgent.run(
      'demo-atlas', 'Demo-Atlas', 'demo-gw', 'claude-sonnet-4-6', 'Software Development',
    ...
    this.s.insertAgent.run(
      'demo-nova', 'Demo-Nova', 'demo-gw', 'claude-sonnet-4-6', 'Operations & Monitoring',
      'idle', 'webchat', '~/.openclaw/workspace-nova', '30m', 3,
      'Demo agent for infrastructure monitoring, email triage, and operational tasks.'
    );

    log.info('agent-store', 'Demo agents seeded: Demo-Atlas (dev), Demo-Nova (ops)');
  }
